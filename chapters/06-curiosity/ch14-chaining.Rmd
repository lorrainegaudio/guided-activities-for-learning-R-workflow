...
## 🛠 Building a Pipeline {#build-pipe}
...
### Start with the data {#start-data}
...
### Create a new variable with `mutate()` {#mutate}
...
### Keep only cars using greater than 8 L/100 km {#filter}
...
### Group and summarize {#group-summarize}
...
### Recode transmission for readability {#recode}
