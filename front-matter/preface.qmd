...
- [RStudio Desktop]{.glossary-term data-term="RStudio Desktop"} is an [integrated development environment]{.glossary-term data-term="Integrated Development Environment"} (IDE) that makes writing, running and organizing R code easier. In this course, you will always use RStudio to interact with R. You must use the **desktop** version locally (not the Posit Cloud or other browser-based tools).
